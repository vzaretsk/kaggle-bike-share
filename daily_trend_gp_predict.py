...
weekdays_X = np.array((daily_sum_df[daily_sum_df["workingday"] == 1].index -
                        daily_sum_df[daily_sum_df["workingday"] == 1].index[0]) / np.timedelta64(1, "D"))
weekends_X = np.array((daily_sum_df[daily_sum_df["workingday"] == 0].index -
                        daily_sum_df[daily_sum_df["workingday"] == 0].index[0]) / np.timedelta64(1, "D"))
